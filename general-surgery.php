...
if (isset($_POST['search']) && !empty($_POST['search_query'])) {
  ...
  $sql_select = "SELECT * FROM appointment, doctor WHERE DoctorID = UserID AND Specialization = 'General-Surgery' AND status = 'Available' AND doctor.doctor_name LIKE '%$search_query%'";
} else {
  $sql_select = "SELECT * FROM appointment, doctor WHERE DoctorID = UserID AND Specialization = 'General-Surgery' AND status = 'Available'";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>General Surgery Details and Appointment</title>
  ...
  <div class="container">
    ...
    if ($result->num_rows > 0) {
      ...
      while ($row = $result->fetch_assoc()) {
        ...
        <td>" . $row['Status'] . "</td>
        <td><a href='APPointment.php?id=" . $row['AppointmentID'] . "' class='btn btn-primary'>Select</a></td>
      </tr>";
      }
      echo "</tbody>
      </table>
