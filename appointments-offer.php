...
if (isset($_POST['search']) && !empty($_POST['search_query'])) {
    ...
    $sql = "SELECT appointment.*, user.FullName 
        FROM appointment 
        INNER JOIN user ON appointment.DoctorID = user.ID WHERE user.FullName LIKE '%$searchQuery%'";
} else {
    $sql = "SELECT appointment.*, user.FullName 
        FROM appointment 
        INNER JOIN user ON appointment.DoctorID = user.ID";
}
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="nav flex-column">
            ...
            <a class="nav-link active" href="appointments-offer.php"><i class="fas fa-calendar-alt me-2"></i>
                Appointment Offers</a>
    ...
    <div class="content" id="content">
        <div class="container-fluid">
            <h2 class="text-center mb-4">Appointment Offers</h2>

            <div class="row mb-3">
                <div class="col-md-6">
                    <form method="post" class="d-flex">
                        <input type="text" name="search_query" class="fo rm-control me-2"
                ...
                <div class="col-md-6 text-end">
                    <a href="add-offer.php" class="btn btn-success add-offer-btn"><i class="fas fa-plus"></i> Add
                        Appointment Offer</a>
                </div>
            </div>
                        ...
                        <tbody>
                            <?php while ($row = $result->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td><?= $row['Status'] ?></td>
                                    <td><a href="edit-offer.php?id=<?= $row['AppointmentID'] ?>"><i
                                                class="fas fa-pencil-alt"></i></a></td>
                                    <td><a href="delete-offer.php?id=<?= $row['AppointmentID'] ?>"
