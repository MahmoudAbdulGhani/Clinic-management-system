...
if (isset($_POST['search']) && !empty($_POST['search_query'])) {
    ...
    $sql = "SELECT appointment.*, appointment.doctor_name, Specialization
        FROM appointment 
        INNER JOIN doctor ON appointment.DoctorID = UserID 
        WHERE appointment.Status = 'Canceled' AND appointment_date LIKE '%$searchQuery%'";
...
<head>
    ...
    <title>Canceled Appointment - Medicare Hub</title>
        ...
        <div class="container-fluid">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6 d-flex justify-content-end gap-2">
                    <a href="appointments.php" class="btn btn-success add-offer-btn"><i class="fas fa-eye"></i>
                        Appointment</a>
                </div>
            ...
            <?php else: ?>
                <div class="no-appointments text-center">
                    <div class="no-appointments-message">
                        <h3>No canceled appointments found</h3>
                        <p>It looks like there are no Canceled appointments at the moment.
                    </div>
                </div>
            <?php endif; ?>
        </div>
